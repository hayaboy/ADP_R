...
# party 패키지(Unbiased recursive partitioning based on permutation test 방법을 이용) 
...
# 과대 적합은 training data에서는 정확도가 높지만, 새로운 데이터가 입력되면 잘못 예측
# 할 수있다. 
# 과소 적합은 training data조차도 정확도가 떨어진다.

## 과대적합과 과소 적합의 문제점을 해결하기 위해서는 더많고 더다양한 데이터를 확보하고,
