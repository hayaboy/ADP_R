...
car_data<-read.csv('auto-mpg.csv', header=FALSE)
str(car_data)
colnames(car_data)<-c('mpg','cylinders','displacement','horsepower','weight','acceleration','model year','origin','name')
colnames(car_data)
